...
|----|-------|----------|-------|
| BL-001 | Sélecteur de devise configurable (FCFA par défaut, choix autre devise) | Moyenne | Le user veut pouvoir configurer une autre devise depuis l'admin sans coder. `priceXof` reste la devise canonique. |
