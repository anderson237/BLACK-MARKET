...
// Unified elegant stroke-icon set (24x24, lucide-style).
// Usage: <AppIcon name="edit" class="w-4 h-4" />
...
const PATHS: Record<string, string> = {
  ...
  video: '<rect x="2" y="6" width="14" height="12" rx="2"/><polygon points="16 10 22 7 22 17 16 14"/>',
...
const inner = computed(() => PATHS[props.name] || PATHS.plus)
</script>
