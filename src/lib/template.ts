...
export function getHtmlTemplateCode(opts?: { siteUrl?: string }): string {
  const siteUrl = (opts && opts.siteUrl) || "https://anderson237.github.io/BLACK-MARKET/";
  ...
  <script>
    ...
    function renderGrid(itemsToRender) {
      ...
      itemsToRender.forEach(p => {
        ...
        const message = "Bonjour, je souhaite commander le produit [" + String(p.title || "").toUpperCase() + "] au prix de [" + priceStr + "]. Voici le produit : " + SITE_URL + "p/" + p.id + ".html";
